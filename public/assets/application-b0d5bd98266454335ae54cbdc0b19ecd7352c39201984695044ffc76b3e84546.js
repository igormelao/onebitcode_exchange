...
(function() {
  var changeCurrenciesValues, isQuantityValid, postForm;
    ...
    if ($('form').attr('action') === '/exchange') {
      $.ajax('/exchange', {
        ...
        success: function(data, text, jqXHR) {
          return $('#result').text($("#quantity").val() + " " + $("#currency").val() + " = " + data.value + " " + $("#currency_destination").val());
        }
      });
      return false;
    }
  ...
  changeCurrenciesValues = function() {
